...
datos = read.table("/Users/DanniC/Desktop/Datasets/JapaneseCredit/crx.txt",header = F)
datos2 = datos[,2:7]
...
for(i in 1:nrow(datos)){
  datos[i,8] <- paste(toString(CC_euc$vectorFinal[i]))
}


ari <- adjustedRandIndex(unlist(datos[,1]),unlist(datos[,8]))
ari
