...
indKMEANS=0
res <- kmeans(datos2, 2)
maxARIK <- adjustedRandIndex(unlist(datos[,31]),unlist(res$cluster))
indKMEANS=2

for (j in 2:20) {
  res <- kmeans(datos2, j)
  ariK <- adjustedRandIndex(unlist(datos[,31]),unlist(res$cluster))
...
maxARIW = adjustedRandIndex(unlist(datos[,31]),unlist(clusterCutW))
maxARIC = adjustedRandIndex(unlist(datos[,31]),unlist(clusterCutC))
maxARIS = adjustedRandIndex(unlist(datos[,31]),unlist(clusterCutS))
...
for(i in 2:20){
  ...
  #ARI WARD
  ari1 <- adjustedRandIndex(unlist(datos[,31]),unlist(clusterCutW))
  ...
  ari2 <- adjustedRandIndex(unlist(datos[,31]),unlist(clusterCutC))
  ...
  #ARI SINGLE LINKAGE
  ari3 <- adjustedRandIndex(unlist(datos[,31]),unlist(clusterCutS))
